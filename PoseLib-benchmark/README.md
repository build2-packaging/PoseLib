...
Note that the `PoseLib-benchmark` executable in this package provides `build2` metadata.


## Usage

To start using `PoseLib-benchmark` in your project, add the following build-time
